...
```powershell
.\SmartKit-Simulator-1.0.2.exe --automation `
...
```powershell
.\SmartKit-Simulator-1.0.2.exe --attach-management-url http://127.0.0.1:35800
```
...
electron/dist/SmartKit-Simulator-1.0.2.exe
```

最终交付文件为 `electron/dist/SmartKit-Simulator-1.0.2.exe`。
